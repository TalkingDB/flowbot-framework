...
export default function FileList({ filename
}: { filename: string }) {
            ...
            <li className="px-6 py-4">
                <div className="flex justify-between">
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <p className="text-gray-700">AI Trained</p>
                    </div>
                    <span className="text-gray-500 text-xs"><button className={styles.crossiconButton} onClick={removeSelectedField}  >
