...
const DynamicTable: React.FC<TableProps<string[]>> = ({ data, onChange, options, total }) => {
    ...
    return (
        ...
        {options?.bottomAddButton && <div className='flex gap-2 align-middle mt-4 cursor-pointer w-fit' onClick={addRow}>
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="21" viewBox="0 0 20 21" fill="none">
