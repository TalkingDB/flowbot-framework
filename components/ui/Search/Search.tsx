...
const SearchInput: React.FC<TextInputProps> = ({ width, disabled, containerwidth, onChange }) => {
    const inputStyle = {
    ...
    return (
        <>
            ...
            {showButton && <div className='pt-4'>
                <Button onClick={() => { onChange(value); setShowButton(false) }}>Confirm</Button>
            </div>}
        </>
    );
};
